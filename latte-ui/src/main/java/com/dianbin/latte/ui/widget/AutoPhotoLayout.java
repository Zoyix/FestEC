...
/**
 * Created by zhouyixin on 2018/1/13.
 */
...
public class AutoPhotoLayout extends LinearLayoutCompat {
    ...
    private void createNewImageView() {
        ...
        //TODO 直接设1，2，3不怕重复？不是说id要有专门的xml的么？
...
//        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        ...
        for (int i = 0; i < cCount; i++) {
            ...
            if (lineWidth + childWidth > sizeWidth - getPaddingLeft() - getPaddingRight()) {
                ...
                lineWidth += childWidth;
                //得到当前最大的高度
                lineHeight = Math.max(lineWidth, childHeight);
            }
            //最后一个子控件
            if (i == cCount - 1) {
                width = Math.max(lineWidth, width);
                //判断是否超过最大拍照限制
                //TODO 可以解决 这里为什么要加上面的注释？这里也不用判断啊？
                height += lineHeight;
            }
        }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < cCount; i++) {
            ...
            if (childWidth + lineWidth + lp.leftMargin + lp.rightMargin > width - getPaddingLeft() - getPaddingRight()) {
                ...
                //重置宽和高
                lineWidth = 0;
                //TODO 可以解决 lineHeight = 0 可以么？
                lineHeight = childHeight + lp.topMargin + lp.bottomMargin;
                //重置View集合
                mLineViews.clear();
            }
            lineWidth += childWidth + lp.leftMargin + lp.rightMargin;
            //TODO 问老师 视频里是lineHeight + lp.topMargin + lp.bottomMargin 错的
        ...
        for (int i = 0; i < lineNum; i++) {
            ...
            for (int j = 0; j < size; j++) {
                ...
                //为什么减mImageMargin，难道mImageMargin包含在子View里的么？ 他是从子view占据的地方减，其实不太合适
                //TODO 可以优化
